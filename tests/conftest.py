...
def USDC(Contract):
    yield Contract.from_explorer(
        ...
        as_proxy_for="0x0882477e7895bdC5cea7cB1552ed914aB157Fe56",
    )
...
def TUSD(Contract):
    yield Contract.from_explorer(
        ...
        as_proxy_for="0x0000000000085d4780B73119b644AE5ecd22b376",
    )
...
def BUSD(Contract):
    yield Contract.from_explorer(
        ...
        as_proxy_for="0x5864c777697Bf9881220328BF2f16908c9aFCD7e",
    )
...
def REP(Contract):
    yield Contract.from_explorer(
        ...
        as_proxy_for="0x6C114B96b7a0e679C2594E3884f11526797e43D1",
    )
